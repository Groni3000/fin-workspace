...
mod tests {
    ...
    fn test_stock_serialize() {
        ...
        let expected = "{\"base\":{\"name\":\"AAPL\",\"class\":\"Equity\"},\"quote\":{\"name\":\"USD\",\"class\":\"Currency\"},\"mic\":\"XNAS\"}";
    ...
    fn test_stock_deserialize() {
        let expected = aapl();
        let stock_str = "{\"base\":{\"name\":\"AAPL\",\"class\":\"Equity\"},\"quote\":{\"name\":\"USD\",\"class\":\"Currency\"},\"mic\":\"XNAS\"}";
